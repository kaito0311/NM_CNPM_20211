...
//		}
//		try {
//			TabPane root = (TabPane)FXMLLoader.load(getClass().getResource("Sample1.fxml"));
...
//		}
//		try {
//			TabPane root = (TabPane)FXMLLoader.load(getClass().getResource("Sample2.fxml"));
//			Scene scene = new Scene(root,1440,1024);
...
//		}
//		try {
//			TabPane root = (TabPane)FXMLLoader.load(getClass().getResource("Sample3.fxml"));
//			Scene scene = new Scene(root,1440,1024);
...
//		}
		try {
			TabPane root = (TabPane)FXMLLoader.load(getClass().getResource("Sample4.fxml"));
			Scene scene = new Scene(root,1440,1024);
