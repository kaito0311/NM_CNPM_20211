...
//		FormulaEvaluator formula = wb.getCreationHelper().createFormulaEvaluator();System.out.println();
//
//		for (Row row:sheet) {
...
//	}
	...
	public static void writeExcel(ArrayList<Person> listPerson) throws IOException {
		FileOutputStream file = new FileOutputStream("src/MainCreateListScholar/Write.xlsx");
