...
public class PersonDetailController implements Initializable {
	...
	public void showDetail() {
		...
		System.out.println(nk.getPerson().getFullName());
		...
		noiSinh.setText(nk.getBirthPlace().getAddress());
		que.setEditable(false);
		que.setText(nk.getOriginPlace().getAddress());
		...
		diaChi.setText(nk.getOriginPlace().getAddress());
