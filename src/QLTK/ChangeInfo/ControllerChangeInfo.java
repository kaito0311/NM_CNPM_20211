...
public class ControllerChangeInfo implements Initializable{
	...
	public void logOut(ActionEvent event) {
		try {
			Parent root = FXMLLoader.load(getClass().getResource("/Login/UI_Login.fxml"));
...
//			scene.getStylesheets().add(getClass().getResource("Login.css").toExternalForm());
	...
	public void changeToChangeKey(ActionEvent event) {
		try {
			AnchorPane root = (AnchorPane)FXMLLoader.load(getClass().getResource("/QLTK/ChangeKey/UI_ChangeKey.fxml"));
			stage = (Stage)((Node)event.getSource()).getScene().getWindow();
...
//		positionName = txtPosition.getText();
		if (fullName.equals("") || phone.equals("") || email.equals("")) {
			...
			lbNotice.setText("Thay đổi thông tin cá nhân thành công!");
		}
